const PrivacyPolicy = () => (
  <div className="max-w-3xl mx-auto px-4 py-10 text-gray-800 mt-8">
    ...
    <ul className="list-disc ml-6 mb-4">
      <li>
        Personal Information: Name, email address, mobile number, and other
        information you provide during registration or use of our services.
      </li>
      <li>
    ...
    <p className="mb-4">
      ...
      our website and conducting our business, provided they agree to keep this
    ...
    <p className="mb-4">
      You may review, update, or delete your personal information by contacting
      us. We will respond to your request as soon as possible.
    </p>
    <h2 className="text-xl font-semibold mt-6 mb-2">
