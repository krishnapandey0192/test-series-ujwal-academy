...
import { Video, FileText, Users, Award, Clock, Smartphone, Headphones, TrendingUp, Zap, Shield, Heart, Target } from 'lucide-react';
...
const Features = () => {
  const features = [
    {
      ...
      description: 'Interactive live sessions with expert faculty members for real-time doubt resolution',
    ...
    },
    {
      ...
      description: 'Comprehensive study materials and practice papers designed by subject experts',
    ...
    },
    {
      icon: Award,
      title: 'Mock Tests',
      description: 'Regular mock tests with detailed analysis to track your progress and performance',
    ...
    },
    {
      icon: Smartphone,
      title: 'Mobile App',
      description: 'Learn on-the-go with our mobile app featuring lectures, tests, and study materials',
    ...
    },
    {
      icon: Headphones,
      title: '24/7 Support',
      description: 'Round-the-clock academic and technical support for all your queries',
    ...
    },
    {
      ...
      description: 'Detailed performance analytics to help you identify strengths and weaknesses',
  ...
  return (
    <section id="features" className="py-20 bg-gradient-to-br from-white via-purple-50/30 to-blue-50/30 relative overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-40 h-40 bg-blue-300/20 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-20 right-10 w-56 h-56 bg-purple-300/20 rounded-full blur-3xl animate-float" style={{animationDelay: '2s'}}></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-5xl md:text-6xl font-black text-gray-900 mb-6">
            Why Choose <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Ujjawal Academy</span>
          </h2>
          <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            We provide comprehensive features and services to ensure your success in competitive examinations
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {features.map((feature, index) => (
            ...
            >
              <div className={`bg-gradient-to-r ${feature.color} w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 shadow-xl`}>
        ...
        <div className="relative animate-fade-in-up" style={{animationDelay: '0.8s'}}>
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 rounded-3xl p-8 md:p-16 text-center text-white shadow-2xl overflow-hidden relative">
            ...
            <div className="absolute inset-0">
              ...
              <div className="absolute bottom-10 left-20 w-24 h-24 bg-white/10 rounded-full animate-float" style={{animationDelay: '2s'}}></div>
              <div className="absolute bottom-20 right-10 w-12 h-12 bg-white/10 rounded-full animate-float" style={{animationDelay: '0.5s'}}></div>
            </div>
            ...
            <div className="relative z-10">
              <div className="flex justify-center mb-8">
                <div className="flex space-x-4">
                  ...
                  <Target className="h-12 w-12 text-green-300 animate-pulse" style={{animationDelay: '0.5s'}} />
                  <Heart className="h-12 w-12 text-pink-300 animate-pulse" style={{animationDelay: '1s'}} />
                </div>
              </div>
              
              <h3 className="text-4xl md:text-5xl font-black mb-6">Ready to Start Your Journey?</h3>
              <p className="text-xl md:text-2xl mb-10 opacity-90 max-w-3xl mx-auto leading-relaxed">
                Join thousands of successful students who achieved their dreams with Ujjawal Academy
              </p>
